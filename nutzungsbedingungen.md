---
title: Nutzungsbedingungen – LeafKeep
---

# Nutzungsbedingungen – LeafKeep

[Datenschutzerklärung](datenschutz.md) · [Impressum](impressum.md) · [English](terms.md)

Stand: 31. August 2026

Diese Nutzungsbedingungen gelten für die Android-App **LeafKeep**
(Paket-ID: `com.leafkeep.plants`), angeboten von:
...
Mit dem Herunterladen, Installieren oder Nutzen von LeafKeep erkennen Sie
diese Nutzungsbedingungen an. Wenn Sie damit nicht einverstanden sind,
nutzen Sie die App bitte nicht.

## 2. Beschreibung des Dienstes

LeafKeep ist eine Gieß-Erinnerung für Pflanzen und wird in einer kostenlosen und einer
Premium-Variante angeboten:

- **Kostenlos**: bis zu 8 Pflanzen erfassen.
- **Premium** (kostenpflichtiges Abonnement über Google Play Billing):
  unbegrenzt viele Pflanzen; zugleich unterstützen Sie damit die
...
LeafKeep plant Erinnerungen lokal auf Ihrem Gerät über den
Standard-Planungsmechanismus von Android, damit Sie rechtzeitig darauf
hingewiesen werden, bevor eine Pflanze gegossen werden muss. Die Zustellung dieser
...
LeafKeep sagt daher nicht zu, dass eine Erinnerung zu einem bestimmten
...
LeafKeep speichert Ihre Pflanzendaten lokal auf Ihrem Gerät und lädt sie
...
Verlassen Sie sich bitte nicht allein auf LeafKeep, wenn es um die Pflegehistorie Ihrer Pflanzen oder andere wichtige Angaben geht. Insbesondere die Kennzeichnung „giftig für Haustiere“ ist ein Hinweis, den Sie selbst setzen; sie ersetzt keine gesicherte botanische oder tiermedizinische Auskunft — ziehen Sie bei Fragen zur Sicherheit Ihrer Tiere stets eine fachkundige Quelle hinzu.
